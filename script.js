    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חוזים משפחתיים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '5812096c-5af9-42ff-90b5-2d3fcf76fd35',
                    name: data.name || '',
                    email: data.email || '',
